...
template<typename dataType>
void
Transform<dataType>::setAsProjectionWith(const double xFov, const double yFov, const double near,
										 const double far){
...
template<typename dataType>
void Transform<dataType>::setAsCameraTransTowards(const dPoint& pos, const dPoint& towardsPose,
												  const dPoint& up){
